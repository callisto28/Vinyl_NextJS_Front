...
export const Mention = () => {
  return (
    <div className="flex flex-col content-center mx-56 items-center text-center font-philosopher">
      <h1 className="font-extrabold text-xl">Mentions légales</h1>
      <h3 className=" text-base">En vigueur au 18/07/2022</h3>
      <p>
        ...
        visiteurs, ci-après l&apos;
        <span className="font-bold">&quot;Utilisateur&quot;</span>, du site
        www.vinyltouch.fr , ci-après le{" "}
        <span className="font-bold">&quot;Site&quot;</span>, les présentes
        mentions légales.
      </p>
      <br />
      <p>
      ...
      <br className="border-t border-2 border-black" />
      ...
      <p>
        ...
        est situé au 222 Bd Gustave Flaubert, 63000 Clermont-Ferrand , avec{" "}
        <span>le numéro de téléphone : 0444446040 </span>.
      </p>
      <br />
      <h2 className=" text-base font-semibold border-b-2 border-gray-400">
        ARTICLE 3 - UTILISATION ET RESPONSABILITÉ
      </h2>
      <br />
      <p>
        Le site est accessible en tout endroit, 7j/7, 24h/24 en cas de force
