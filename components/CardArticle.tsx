    ...
    return (
        <div className="">
            <div className="flex flex-col items-center py-2  ">
                <div className="mx-1 border-2 hover:bg-gray-300  border-blueCC rounded-4xl max-w-sm  h-128 flex flex-col justify-around items-center px-3" key={keyCard}>
                    ...
                    <p className="text-gray-400   text-center font-philosopher">{new Date(parseInt(dateCard)).toLocaleString('fr-FR', { month: 'long', day: 'numeric', year: 'numeric' })}

                    </p>
                    <h3 className="text-gray-400 text-right font-light text-xs font-chelsea">
                        {authorCard.toUpperCase()}
                    </h3>


                    <Link href={link} as={linkTitle} passHref ><button className='rounded-full
                                                    hover:text-white
                                                    ...
                                                    mb-5 ' >&rarr; Voir plus</button></Link>
                </div>
