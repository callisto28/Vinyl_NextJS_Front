...
export default function Navbar() {
    ...
    return (
        <div className='font-chelsea border-b-2 border-blueCC z-50 lg:z-50 sm:z-50 text-center absolue'>
                ...
                <Link href='/'>
                    <a className='inline-flex lg:items-center sm:items-center h-14 p-2 lg:ml-20 sm:ml-6 '>
                        ...
                        <div className='flex flex-col'>
                            <h1 className='lg:text-xxxl sm:text-xl text-black  font-bold uppercase tracking-wide px-2'>
                            VinylTouch 
                            </h1>
